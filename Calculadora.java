...
public class Calculadora {
	...
	private static Texto texto_resultado;
	...
	private void dibujaCalculadora() {
		...
		text_resultado = new Text(shlCalculadora, SWT.BORDER);
		text_resultado.setText("0");
		text_resultado.setBounds(22, 19, 196, 21);
	...
	public int getResultadoInt() {
		String resultado = text_resultado.getText();
	...
	public void anadeNuevoDigito(int digit){
		...
		if ((!inputString.equals("0") || digito > 0) && inputString.length() < MAX_DIGITS){
			setResultatString(inputString + digito);
		}
	...
	public void muestraResultado(int resultado){
		setResultatString(Integer.toString(resultado));
		valor1 = resultado;
		modo = MODE_RESULTADO;
		inicializa_resultado = true;
	}
